...
model {
    ...
    beta_produkcja[1] ~ normal(5, 0.5);
    beta_produkcja[2] ~ normal(-1.75, 0.3);
    beta_produkcja[3] ~ normal(3, 0.4);
...
generated quantities {
  ...
  for (i in 1:n) {
    ...
    y_produkcja_pred_test[i] = fmax(normal_rng(mu_produkcja[i], sigma_produkcja),0.1);
  }
}